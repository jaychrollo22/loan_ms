            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <form method='POST' action='{{url('update-loan/'.$loan->id)}} ' onsubmit='show()' enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 form-group">
                                      ...
                                      <select data-placeholder="Select Borrower" class="form-control form-control-sm required js-example-basic-single "
                                        ...
                                        @foreach ($borrowers as $borrower)
                                          <option value="{{ $borrower->id }}" {{ $borrower->id == $loan->borrower_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 form-group">
                                      ...
                                      <select data-placeholder="Select Loan Type" class="form-control form-control-sm required js-example-basic-single "
                                        ...
                                        @foreach ($loan_types as $loan_type)
                                          <option value="{{ $loan_type->id }}" {{ $loan_type->id == $loan->type ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 form-group">
                                      ...
                                      <select data-placeholder="Select Loan Term" class="form-control form-control-sm required js-example-basic-single "
                                        ...
                                        @foreach ($loan_terms as $loan_term)
                                          <option value="{{ $loan_term->name }}" {{ $loan_term->name == $loan->term ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 form-group">
                                      ...
                                      <select data-placeholder="Select Loan Interest" class="form-control form-control-sm required js-example-basic-single "
                                        ...
                                        @foreach ($loan_interests as $loan_interest)
                                          <option value="{{ $loan_interest->name }}" {{ $loan_interest->name == $loan->interest ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 form-group">
                                      ...
                                      <input type="number" name="amount" step="any" class="form-control" placeholder="0.00" value="{{ $loan->amount }}">
                                    </div>
